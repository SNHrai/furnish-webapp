...
import { Menu, X, Home, Calculator, Briefcase, Phone, Info, BarChart3, MessageCircle } from 'lucide-react'
          ...
          >
            ...
            {onChatToggle && (
              <button
                ...
                className="p-3 rounded-full bg-blue-600 hover:bg-blue-700 text-white transition-colors shadow-lg hover:shadow-xl"
                title="Open Chat"
              >
            ...
            >
              <div className="container-elegant py-4">
                ...
                >
                  <Link
                    href="/calculator"
                    className="btn-luxury w-full text-center block mb-3"
                    onClick={() => setIsOpen(false)}
                  >
                    Get Quote
                  </Link>
